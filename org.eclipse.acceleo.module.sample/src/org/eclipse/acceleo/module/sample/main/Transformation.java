...
/**
 * Entry point of the 'Transformation' generation module.
 *
 * @generated
 */
public class Transformation extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/sample/main/Transformation";
     ...
     * @generated
     */
    public Transformation(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Transformation(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Transformation generator = new Transformation(modelURI, folder, arguments);
